...
<a href="https://tujjari.com"><img src="logoimg" style="height: 65px; width: 160px;" ></a>
  ...
  <form id="signup-form" method="post">
    ...
    <input id="signup-email" type="text" name="email" value="<?php if(isset($_COOKIE['emailcookie'])) { echo $_COOKIE['emailcookie']; } else if(isset($_SESSION['wrong_email'])){$wrong_email = $_SESSION['wrong_email']; echo $wrong_email; }?>"  style="width: 360px !important;" required oninvalid="this.setCustomValidity('Enter User Name Here')"
  oninput="this.setCustomValidity('')"/>
    <label  style="font-size: 15px;padding-right: 290px;"><b>Password</b> <span id='message'></span><div id="checkpass"></div></label><br>
    <input id="signup-pass" type="password" name="pass" value="<?php if(isset($_COOKIE['passwordcookie'])) { echo $_COOKIE['passwordcookie']; } ?>" style="width: 360px !important;" required oninvalid="this.setCustomValidity('Enter User Name Here')"
  oninput="this.setCustomValidity('')"/>
    <div>
    <br>
...
<script>
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyCcrcFNZmY8csvYHsDRlb96LYDDmqmyJck",
    authDomain: "chatting-a8ca8.firebaseapp.com",
    databaseURL: "https://chatting-a8ca8-default-rtdb.firebaseio.com",
    projectId: "chatting-a8ca8",
    storageBucket: "chatting-a8ca8.appspot.com",
    messagingSenderId: "731919063970",
    appId: "1:731919063970:web:5a82d3669ee25a8ad470fb",
    measurementId: "G-5507S374PN"
  };
  // Initialize Firebase
