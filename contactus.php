...
<?php include 'navbar.php'; ?>
	<div class="bg-contact">
		<div class="container contact-box">
			<h1 style="font-family: 'Source Sans Pro', sans-serif;">Contact us</h1>
			<form action="php/contactform-process.php" method="post">
				<input class="form-control text-box" type="text" name="name" placeholder="Please enter your name" required>
				<input class="form-control text-box" type="text" name="email" placeholder="Please enter your email" required>
      	<textarea style="margin-top: 35px; margin-bottom: 25px;border-radius: 20px !important; height: 200px !important; box-shadow: 0 1px 5px rgba(0, 0, 0, 0.05);" type="text" name="message" placeholder="Enter Message" class="form-control" required></textarea>
        <div class="form-group checkbox">
            <input type="checkbox" name="terms" id="cterms" value="Agreed-to-Terms" required> I have read and agree with Tujjari's stated <a href="privacy-policy.html">Privacy Policy</a> and <a href="terms-conditions.html">Terms Conditions</a> 
            <div class="help-block with-errors"></div>
        </div>
        <center>
      		<button style="margin-bottom: 50px; font-family: 'Source Sans Pro', sans-serif; border-radius: 21px; width: 160px; height: 42px; color: white; outline: none; background: rgb(255,0,0); background: linear-gradient(90deg, rgba(255,0,0,1) 0%, rgba(255,47,1,1) 35%, rgba(254,93,0,1) 58%, rgba(255,98,0,1) 100%, rgba(215,49,203,1) 100%, rgba(208,108,235,1) 100%, rgba(11,11,11,1) 100%); " class="btn" name="submit" type="submit">SUBMIT</button> 
      	</center>
			</form>
		</div>
	</div>
...
<?php include 'php/contactform-process.php'; ?>