...
<?php
  ...
  else if((isset($_SESSION['ad_title'])) && (isset($_SESSION['user_id'])))
  {
            $ad_title_copy = $_SESSION['ad_title'];
            $user_id_copy = $_SESSION['user_id'];
            $select = "select * from free_ad where user_id = '$user_id' AND title = '$ad_title_copy'";
...
<?php include 'navbar.php'; ?>
    ...
    <form method="post">
      <div class="boxer"><br>
        <div class="container">
          ...
          <div class="row">
            <label class="ml-4">Enter Contact Number</label>
            <input required value="<?php echo $phone; ?>" class="m-auto form-control locu" type="text" name="phone">
          </div><br>
        </div>
      </div>
      <input class="invisible" id="latitude" name="latitude" type="text" value="<?php echo htmlspecialchars($latitude); ?>">
      <input class="invisible" id="longitude" name="longitude" type="text" value="<?php echo htmlspecialchars($longitude); ?>">
      <center>
  ...
  <script>
    ...
    // var latitude = div1.textContent;
    // var div2 = document.getElementById("longitude");
    // var longitude = div2.textContent;
