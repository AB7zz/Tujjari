...
<a href="https://tujjari.com"><img class="loginlogo" src="images/logo.png" style="height: 65px; width: 160px;" ></a>
  ...
  <h3 style="font-size: 30px;" >Forgot your password?</h3>
  <p>Enter your email below and a link will be sent to your email to reset your password</p>
  <form method="post">
    <label  style="font-size: 15px; padding-right: 320px;" ><b>Email</b> <span id='message'></span></label><br>
    <input id="email" type="text" name="email" value="<?php if(isset($_COOKIE['emailcookie'])) { echo $_COOKIE['emailcookie']; } else if(isset($_SESSION['wrong_email'])){$wrong_email = $_SESSION['wrong_email']; echo $wrong_email; }?>"  style="width: 360px !important;" required oninvalid="this.setCustomValidity('Enter User Name Here')"
  oninput="this.setCustomValidity('')"/><br>
    ...
    <button name="submit" class="btn btn-danger mt-1" style="width: 360px;">Submit</button>
...
<?php include 'php/reset-pass-request-process.php'; ?>