...
<a href="https://tujjari.com"><img src="images/logo.png" class="registerlogo" style="height: 65px; width: 160px;"></a>
   </div>
  ...
  ?>
    ...
    <input type="text" name="name" class="ml-3" style="width: 360px !important;" required value="<?php if ($wrongy==1){echo $name;} if($wrongy==2){echo $name;}  if($wrongy==3){echo $name;}?>">
    <label class="ml-3" style="font-size: 15px;padding-right: 330px;" ><b>Email</b></label><br>
    <input type="text" name="email" class="ml-3" style="width: 360px !important;" required value=" <?php if($wrongy==2){echo $email;}  if($wrongy==3){echo $email;}?>" >
    <label class="ml-3" style="font-size: 15px;padding-right: 300px;"><b>Password</b></label><br>
    <input type="password" name="pass" class="ml-3" placeholder="At least 5 characters" style="width: 360px !important;" required value="<?php if($wrongy==1){echo $pass;} if($wrongy==3){echo $pass;}?>">
    ...
    <input type="Phone" name="phoney" placeholder="Optional" class="ml-3" style="width: 360px !important;"value="<?php if ($wrongy==1){echo $phoney;} if($wrongy==2){echo $phoney;}if($wrongy==3){echo $phoney;}?>" >
        <div>
        <br>
...
<?php
include 'php/register-verify-process.php';
?>